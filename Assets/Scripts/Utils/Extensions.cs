...
public static class Extensions
{
    ...
    public static GameObject ChildOfName(this GameObject obj, string name)
    {
        return obj.transform.Find(name)?.gameObject;
    }

    public static GameObject GameObjectOfNetId(uint netid)
    {
        return UnityEngine.Object.FindObjectsOfType<NetworkIdentity>().FirstOrDefault(o => o.netId == netid)?.gameObject;
    }
}