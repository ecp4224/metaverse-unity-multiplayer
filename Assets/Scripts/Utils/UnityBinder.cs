...
public class BindComponent : Binder
{
	...
	public BindComponent(int index = 0, string fromObject = "", bool errorWhenFailed = true, bool warnOnly = false, bool skipIfNonNull = true)
	{
		this.index = index;
	...
	{
		//Check if null
		if (field.GetValue(obj) != null && skipIfNonNull)
		{
			//Let's double check because Unity dumb
			var value = field.GetValue(obj);
			if (value is UnityEngine.Object && !((UnityEngine.Object) value).Equals(null))
			{
				//Ok it's not actually null
				return;
			}
		}
...
public class BindComponentInChildren : Binder
{
	...
	public override void InjectInto(Object obj, FieldInfo field)
	{
		...
		var unityCall = typeof(GameObject).GetMethod("GetComponentsInChildren", new Type[] { typeof(bool) });
		if (unityCall == null)
		{
			Debug.LogError("Could not find method GetComponents !!");
			return;
		...
		var genericMethod = unityCall.MakeGenericMethod(injectType);
		var rawResult = genericMethod.Invoke(fromObj, new object[]{ true });
...
public class BindComponents : Binder
{
	...
	public BindComponents(string fromObject = "")
	{
		this.index = index;
		this.fromObject = fromObject;
	}
...
/// A MonoBehavior that injects fields in the Awake() function
/// </summary>
public class SerializedBindableMonoBehavior : SerializedMonoBehaviour {
...
#if MIRROR
public abstract class BindableNetworkBehavior : NetworkBehaviour
{
	/// <summary>
	/// The standard Unity Awake() function. This function will invoke UnityBinder.Inject.
	/// 
